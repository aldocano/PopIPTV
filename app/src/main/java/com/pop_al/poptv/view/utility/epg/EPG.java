 ...
 */
        ...
        import com.pop_al.poptv.view.utility.epg.domain.EPGState;
        import com.pop_al.poptv.view.utility.epg.misc.EPGDataImpl;
        import com.pop_al.poptv.view.utility.epg.misc.EPGUtil;
...
public class EPG extends ViewGroup {
    ...
    private static class AsyncLoadProgramImage extends AsyncTask<EPGEvent, Void, Bitmap> {
        ...
        protected android.graphics.Bitmap doInBackground(com.nst.iptvsmarters.view.utility.epg.domain.EPGEvent... r8) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.nst.iptvsmarters.view.utility.epg.EPG.AsyncLoadProgramImage.doInBackground(com.nst.iptvsmarters.view.utility.epg.domain.EPGEvent[]):android.graphics.Bitmap. bs: [B:7:0x000f, B:17:0x0028]
...
*/
            ...
            r5 = 0;
            r3 = 0;
            r6 = r7.epgEvent;	 Catch:{ InterruptedIOException -> 0x0036, Throwable -> 0x0038 }
            r2 = r6.getProgramUrl();	 Catch:{ InterruptedIOException -> 0x0036, Throwable -> 0x0038 }
            if (r2 == 0) goto L_0x0021;
        L_0x000a:
            r4 = new java.net.URL;	 Catch:{ MalformedURLException -> 0x001d, InterruptedIOException -> 0x001f, Throwable -> 0x0038 }
            r4.<init>(r2);	 Catch:{ MalformedURLException -> 0x001d, InterruptedIOException -> 0x001f, Throwable -> 0x0038 }
            r6 = r4.openConnection();	 Catch:{ MalformedURLException -> 0x0046, InterruptedIOException -> 0x0043, Throwable -> 0x003d }
            r6 = r6.getInputStream();	 Catch:{ MalformedURLException -> 0x0046, InterruptedIOException -> 0x0043, Throwable -> 0x003d }
            r5 = android.graphics.BitmapFactory.decodeStream(r6);	 Catch:{ MalformedURLException -> 0x0046, InterruptedIOException -> 0x0043, Throwable -> 0x003d }
            r3 = r4;
        L_0x001c:
            return r5;
        L_0x001d:
        ...
        L_0x0020:
            goto L_0x001c;
        L_0x0021:
            r4 = new java.net.URL;	 Catch:{ InterruptedIOException -> 0x0036, Throwable -> 0x0038 }
            r6 = "https://www.sound-star.nl/wp-content/uploads/2016/05/Dj-in-the-mix_Ultra-HD.jpg";	 Catch:{ InterruptedIOException -> 0x0036, Throwable -> 0x0038 }
            r4.<init>(r6);	 Catch:{ InterruptedIOException -> 0x0036, Throwable -> 0x0038 }
            r6 = r4.openConnection();	 Catch:{ InterruptedIOException -> 0x0040, Throwable -> 0x003d }
            r6 = r6.getInputStream();	 Catch:{ InterruptedIOException -> 0x0040, Throwable -> 0x003d }
            r5 = android.graphics.BitmapFactory.decodeStream(r6);	 Catch:{ InterruptedIOException -> 0x0040, Throwable -> 0x003d }
            r3 = r4;
            goto L_0x001c;
        L_0x0036:
            r0 = move-exception;
        ...
        L_0x0046:
            ...
            goto L_0x001e;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nst.iptvsmarters.view.utility.epg.EPG.AsyncLoadProgramImage.doInBackground(com.nst.iptvsmarters.view.utility.epg.domain.EPGEvent[]):android.graphics.Bitmap");
        }
    ...
    public EPG(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.programTimeFormatLong = new SimpleDateFormat("HH:mm");
    ...
    private void drawTimebar(Canvas canvas, Rect drawingRect) {
        ...
        for (int i = 0; i < HOURS_IN_VIEWPORT_MILLIS / TIME_LABEL_SPACING_MILLIS; i++) {
            ...
            canvas.drawText(EPGUtil.getShortTime(time), (float) getXFrom(time), (float) (drawingRect.top + (((drawingRect.bottom - drawingRect.top) / 2) + (this.mTimeBarTextSize / 2))), this.mPaint);
        }
        canvas.restore();
    ...
    private int getXPositionStart() {
        return getXFrom(System.currentTimeMillis() - ((long) (HOURS_IN_VIEWPORT_MILLIS / 2)));
    }
    ...
    private EPGData mergeEPGData(EPGData oldData, EPGData newData) {
        if (oldData == null) {
            try {
                oldData = new EPGDataImpl(Maps.newLinkedHashMap());
            } catch (Throwable e) {
